...
// ----------------------------------
// 🔥 PAYMENT DISABLED VERSION
// ----------------------------------

// API to "make payment" (dummy)
const paymentRazorpay = async (req, res) => {
    return res.json({
        success: true,
        message: "Payment disabled for development. No Razorpay required.",
        order: {
            id: "test_order_123",
            amount: 100,
            currency: "INR"
...
// API to "verify payment" (dummy)
const verifyRazorpay = async (req, res) => {
    return res.json({
        success: true,
        message: "Payment verification disabled. Always success."
    })
}
