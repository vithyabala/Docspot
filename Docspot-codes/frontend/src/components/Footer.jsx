    ...
    <div className="px-6 md:px-10">
      <div className="grid md:grid-cols-[3fr_1fr_1fr] gap-12 my-10 mt-24 text-sm items-start">
        ...
        <div className="flex items-start gap-4">
          <img className="w-28 mt-1" src={assets.logo} alt="DocSpot Logo" />
          <p className="text-gray-600 leading-6 md:max-w-[75%]">
            <strong>DocSpot – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            ...
            <li>customersupport@DocSpot.in</li>
          </ul>
        </div>
      </div>
      ...
      <p className="py-4 text-sm text-center text-gray-600">
        © 2025 DocSpot.in — All Rights Reserved.
      </p>
    </div>
  );
};
