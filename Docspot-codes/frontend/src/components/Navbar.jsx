...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm pt-2 pb-0 border-b border-b-gray-400 relative z-[999]'>
      ...
      <div className='flex items-center gap-4'>
        ...
        {location.pathname === '/' && (
          <button
            onClick={() => window.open('https://DocSpot-six.vercel.app', '_blank')}
